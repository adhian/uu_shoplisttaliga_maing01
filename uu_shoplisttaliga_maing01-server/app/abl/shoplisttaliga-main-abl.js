...
const Errors = require("../api/errors/shoplisttaliga-main-error.js");
...
const logger = LoggerFactory.get("ShoplisttaligaMainAbl");

class ShoplisttaligaMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["shoplisttaligaMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuShoplisttaliga",
        typeCode: "uu-shoplisttaliga-maing01",
        location: location,
...
module.exports = new ShoplisttaligaMainAbl();
