...
const INITIAL_SHOPPING_LIST = [
  ...
  { id: Utils.String.generateId(), name: "Knife", author: "Serena Doe" },
  { id: Utils.String.generateId(), name: "Balloon", author: "Serena Doe" },
  { id: Utils.String.generateId(), name: "Stone", author: "John Doe" },
  { id: Utils.String.generateId(), name: "Screwdriver", author: "Doe Doe" },
  { id: Utils.String.generateId(), name: "Flashlight", author: "Serena Doe" },
  { id: Utils.String.generateId(), name: "Keyboard", author: "Mariah Done" },
  { id: Utils.String.generateId(), name: "Glasses", author: "John Doe" },
  { id: Utils.String.generateId(), name: "Clock", author: "Serena Doe" },
  { id: Utils.String.generateId(), name: "Backpack", author: "John Doe" },
  { id: Utils.String.generateId(), name: "Headphones", author: "Mariah Done" },
  { id: Utils.String.generateId(), name: "Camera", author: "Serena Doe" },
  { id: Utils.String.generateId(), name: "Towel", author: "John Doe" },
  { id: Utils.String.generateId(), name: "Cup", author: "Serena Doe" },
  { id: Utils.String.generateId(), name: "Umbrella", author: "Mariah Done" },
  { id: Utils.String.generateId(), name: "Pillow", author: "John Doe" },
  { id: Utils.String.generateId(), name: "Bottle", author: "Serena Doe" },
  { id: Utils.String.generateId(), name: "Watch", author: "John Doe" },
  { id: Utils.String.generateId(), name: "Shoes", author: "Serena Doe" },
];
